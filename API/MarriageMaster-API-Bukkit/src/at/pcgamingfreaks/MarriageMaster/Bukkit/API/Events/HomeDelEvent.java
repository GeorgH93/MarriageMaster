...
public class HomeDelEvent extends Event implements Cancellable
{
	...
	/**
	 * @param player The player that deletes his home.
	 * @param marriageData The marriage data of the player containing the home that gets deleted.
	 */
	public HomeDelEvent(@NotNull MarriagePlayer player, @NotNull Marriage marriageData)
	{
		this.player = player;
