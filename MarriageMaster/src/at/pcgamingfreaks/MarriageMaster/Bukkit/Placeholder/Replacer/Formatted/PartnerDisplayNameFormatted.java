...
@PlaceholderName(name = "PartnerDisplayName", aliases = "Partner_DisplayName")
public class PartnerDisplayNameFormatted extends PartnerDisplayName
{
	public PartnerDisplayNameFormatted(MarriageMaster plugin)
	{
		super(plugin);
	}
