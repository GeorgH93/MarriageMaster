...
@PlaceholderName(name = "PartnerName", aliases = { "Partner", "Partner_Name" })
public class PartnerNameFormatted extends PartnerName
{
	public PartnerNameFormatted(MarriageMaster plugin)
	{
		super(plugin);
	}
