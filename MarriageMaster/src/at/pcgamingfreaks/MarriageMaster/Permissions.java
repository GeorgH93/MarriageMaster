...
public class Permissions
{
	...
	public static final String GIFT = BASE + "gift";
	...
	public static final String PVP = BASE + "pvp";
	public static final String ACCEPT = BASE + "accept";
	...
	private Permissions() { /* You should not create an instance of this utility class! */ }
}