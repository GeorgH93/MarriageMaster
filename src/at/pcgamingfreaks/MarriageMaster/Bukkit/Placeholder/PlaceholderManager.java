...
import at.pcgamingfreaks.MarriageMaster.Bukkit.Placeholder.Hooks.DeluxeChatPlaceholderHook;
...
public class PlaceholderManager
{
	...
	public PlaceholderManager(MarriageMaster plugin)
	{
		...
		//region DeluxeChat
		if(isPluginEnabled("DeluxeChat"))
		{
			hooks.add(new DeluxeChatPlaceholderHook(plugin, this));
		}
		//endregion
