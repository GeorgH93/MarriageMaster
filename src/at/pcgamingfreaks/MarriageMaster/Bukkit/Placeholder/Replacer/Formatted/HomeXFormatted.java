...
@PlaceholderName(name = "HomeX", aliases = "Home_X")
public class HomeXFormatted extends PlaceholderReplacerBaseValueHome
{
	public HomeXFormatted(MarriageMaster plugin)
	{
		super(plugin);
	}
