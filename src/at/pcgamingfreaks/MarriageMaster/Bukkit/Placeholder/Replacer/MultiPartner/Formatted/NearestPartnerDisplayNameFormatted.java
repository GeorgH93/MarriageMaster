...
@PlaceholderName(name = "NearestPartnerDisplayName", aliases = { "Nearest_PartnerDisplayName", "Nearest_Partner_DisplayName" })
public class NearestPartnerDisplayNameFormatted extends NearestPartnerDisplayName
{
	public NearestPartnerDisplayNameFormatted(MarriageMaster plugin)
	{
		super(plugin);
	}
